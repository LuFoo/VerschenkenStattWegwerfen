...
#RUN mkdir /verschenkenStattWegwerfen
#WORKDIR /verschenkenStattWegwerfen
#COPY Gemfile /verschenkenStattWegwerfen/Gemfile
#COPY Gemfile.lock /verschenkenStattWegwerfen/Gemfile.lock
#RUN bundle install
#COPY . /verschenkenStattWegwerfen
