class CharitiesController < ApplicationController
  ...
  # GET /charities.json
  def index
    @charities = HTTParty.get('http://www.berlin.de/umwelt/themen/abfall/verschenken-statt-wegwerfen/index.php/index.json',
  ...
  private
    ...
    def charity_params
      params.require(:charity).permit(:name, :goods, :address, :zipcode, :district)
    end
end
